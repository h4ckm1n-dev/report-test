...
|--------------|-----------------------|-----------|
| stdlib | gitlab-agent, velero, kube-prometheus-stack, trivy, policy-reporter, kyverno | 22 |
| libssl3 | backend-ddf, trivy, keycloak, rabbitmq, postgresql | 6 |
...
* La bibliothèque curl est récurrente à travers plusieurs CVE et applications (cves, applications), indiquant des vulnérabilités communes dans cette bibliothèque.
* La bibliothèque glibc est récurrente à travers plusieurs CVE et applications (cves, applications), indiquant des vulnérabilités communes dans cette bibliothèque.
* La bibliothèque glibc-common est récurrente à travers plusieurs CVE et applications (cves, applications), indiquant des vulnérabilités communes dans cette bibliothèque.
