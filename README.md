...
|--------------|-----------------------|-----------|
| stdlib | kube-prometheus-stack, policy-reporter, trivy, kyverno, kube-system, velero, gitlab-agent | 7 |
| libssl3 | keycloak, rabbitmq, postgresql, trivy, backend-ddf | 5 |
| libgnutls30 | keycloak, rabbitmq, kyverno, postgresql | 4 |
...
| github.com/Azure/azure-sdk-for-go/sdk/azidentity | kube-prometheus-stack, trivy | 2 |
| golang.org/x/net | kyverno, velero | 2 |
| google.golang.org/protobuf | kyverno, velero | 2 |
...
* La bibliothèque stdlib est récurrente à travers plusieurs CVE et applications (kube-prometheus-stack, policy-reporter, trivy, kyverno, kube-system, velero, gitlab-agent), indiquant des vulnérabilités communes dans cette bibliothèque.
* La bibliothèque libssl3 est récurrente à travers plusieurs CVE et applications (keycloak, rabbitmq, postgresql, trivy, backend-ddf), indiquant des vulnérabilités communes dans cette bibliothèque.
* La bibliothèque libgnutls30 est récurrente à travers plusieurs CVE et applications (keycloak, rabbitmq, kyverno, postgresql), indiquant des vulnérabilités communes dans cette bibliothèque.
...
| CVE ID | Applications |
|--------|--------------|
| [CVE-2024-24790](#cve-2024-24790) | policy-reporter, kube-prometheus-stack, trivy, kyverno, kube-system, velero |
...
| [CVE-2024-2398](#cve-2024-2398) | kyverno, rabbitmq |
