...
|--------------|-----------------------|-----------|
| stdlib | policy-reporter, kube-prometheus-stack, kyverno, velero, gitlab-agent, trivy | 6 |
| libssl3 | postgresql, keycloak, rabbitmq, backend-ddf, trivy | 5 |
...
* La bibliothèque stdlib est récurrente à travers plusieurs CVE et applications (policy-reporter, kube-prometheus-stack, kyverno, velero, gitlab-agent, trivy), indiquant des vulnérabilités communes dans cette bibliothèque.
* La bibliothèque libssl3 est récurrente à travers plusieurs CVE et applications (postgresql, keycloak, rabbitmq, backend-ddf, trivy), indiquant des vulnérabilités communes dans cette bibliothèque.
...
| CVE ID | Applications |
|--------|--------------|
| [CVE-2024-24790](#cve-2024-24790) | velero, policy-reporter, kube-prometheus-stack, trivy |
