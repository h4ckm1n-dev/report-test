...
|--------------|-----------------------|-----------|
| stdlib | velero, gitlab-agent, kube-prometheus-stack, trivy, policy-reporter, kyverno | 22 |
| libssl3 | postgresql, trivy, keycloak, rabbitmq, backend-ddf | 6 |
...
- La bibliothèque **stdlib** est récurrente à travers plusieurs CVE et applications (velero, gitlab-agent, kube-prometheus-stack, trivy, policy-reporter, kyverno), indiquant des vulnérabilités communes dans cette bibliothèque.
- La bibliothèque **libssl3** est récurrente à travers plusieurs CVE et applications (postgresql, trivy, keycloak, rabbitmq, backend-ddf), indiquant des vulnérabilités communes dans cette bibliothèque.
