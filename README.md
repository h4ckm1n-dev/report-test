...
|--------------|-----------------------|-----------|
| stdlib | kube-prometheus-stack, kube-system, trivy, policy-reporter, gitlab-agent, kyverno, velero | 7 |
| libssl3 | backend-ddf, postgresql, trivy, keycloak, rabbitmq | 5 |
| libgnutls30 | keycloak, postgresql, kyverno, rabbitmq | 4 |
...
* La bibliothèque stdlib est récurrente à travers plusieurs CVE et applications (kube-prometheus-stack, kube-system, trivy, policy-reporter, gitlab-agent, kyverno, velero), indiquant des vulnérabilités communes dans cette bibliothèque.
...
* La bibliothèque libgnutls30 est récurrente à travers plusieurs CVE et applications (keycloak, postgresql, kyverno, rabbitmq), indiquant des vulnérabilités communes dans cette bibliothèque.
...
| CVE ID | Applications |
|--------|--------------|
| [CVE-2024-24790](#cve-2024-24790) | kube-system, policy-reporter, kyverno, kube-prometheus-stack, trivy, velero |
| [CVE-2023-24540](#cve-2023-24540) | velero |
| [CVE-2024-2961](#cve-2024-2961) | kyverno, amazon-cloudwatch |
